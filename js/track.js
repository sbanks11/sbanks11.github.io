...
var campaignID = "6724dbafe4433c5c72dd3c5c";
...
var initialSrc = "https://blog.3questionsurvey.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("blog.3questionsurvey.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://blog.3questionsurvey.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://blog.3questionsurvey.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
